...
def get_data_loaders(args):
    ...
    # 修改为Windows绝对路径
    args.labels, args.label_freqs = get_labels_and_frequencies(
        r"D:\A_CODE\2025\Create\datasets\MVSA_Single\train.jsonl"
    )
    ...
    dev = JsonlDataset(
        ...
        r"D:\A_CODE\2025\Create\datasets\MVSA_Single\dev.jsonl",
        tokenizer,
        transforms,
        vocab,
        args,
    ...
    test_set = JsonlDataset(
        ...
        r"D:\A_CODE\2025\Create\datasets\MVSA_Single\test.jsonl",
        tokenizer,
        test_transforms,
        vocab,
        args,
